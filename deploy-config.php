 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'r2Hv0XgzHG39NjoKEchv3IFvhykmzZVkE90QFlhGMEwZgdF0p5IRH117Ng0');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/iswebdevelopers/Fusioncorporate-portal.git');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/inetpub/FRB/tmp/');
 ...
 */
define('COMPOSER_WORKING_DIR', 'portal');
 ...
 */
define('EMAIL_ON_ERROR', 'iswebdevelopers@fusionretailbrands.com.au');
